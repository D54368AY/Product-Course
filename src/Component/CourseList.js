            ...
            {form ? (
              <Col lg={12}>
                <Row>
                  <Col lg={3} />
                  <Col lg={6}>
                    <Card className="mt-5" bg="dark" varient="dark">
                      <Card.Body>
                        <Form>
                          <Form.Group
                            className="mb-2"
                            controlId="frombasicName"
                          >
                            <Form.Label className="float-left text-light">
                              Full Name
                            </Form.Label>
                            <Form.Control
                              type="text"
                          ...
                          <Form.Group
                            className="mb-2"
                            controlId="frombasicMobileNumber"
                          >
                            <Form.Label className="float-left text-light">
                              Mobile Number
                            </Form.Label>
